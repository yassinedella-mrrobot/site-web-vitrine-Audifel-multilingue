...
const translations = {
  fr: {
    ...
    nav_about: "À propos", nav_solutions: "Nos solutions", nav_steps: "Comment ça marche", nav_contact: "Contact",
    ...
    partners_note: "Logo Audifon en attente — envoyez-moi le fichier officiel et je l'intègre à la place du texte.",
  ...
  en: {
    ...
    nav_about: "About", nav_solutions: "Our solutions", nav_steps: "How it works", nav_contact: "Contact",
    ...
    partners_note: "Audifon logo pending — send me the official file and I'll add it in place of the text.",
  ...
  ar: {
    ...
    nav_about: "من نحن", nav_solutions: "حلولنا", nav_steps: "كيف تسير العملية", nav_contact: "اتصل بنا",
    ...
    partners_note: "شعار Audifon قيد الإضافة — أرسلوا لي الملف الرسمي وسأضيفه بدلاً من النص.",
